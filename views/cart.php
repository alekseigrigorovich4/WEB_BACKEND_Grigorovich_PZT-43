<section class="cart-section" style="padding-top: 120px; padding-bottom: 50px;">
    <div class="container">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px; font-family: 'Poppins', sans-serif;">
                <thead>
                    <tr style="background-color: #f8f8f8; border-bottom: 2px solid #ddd; text-align: left;">
                        <th style="padding: 12px;">Название товара</th>
        ...
        <?php else: ?>
            <p style="font-size: 16px; color: #666;">В корзине пока пусто. Перейдите в <a href="/index.php?route=catalog" style="color: #ff6a00; text-decoration: none; font-weight: 600;">каталог</a>, чтобы выбрать зоотовары.</p>
        <?php endif; ?>
    </div>
</section>