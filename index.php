...
<div class="container">
    ...
    <div class="lab-grid">
        ...
        <div class="lab-card">
            ...
            <div class="lab-path">📁 Папка: <code>ЛР1-СДАНО</code></div>
            <div class="btn-group">
                <a href="./ЛР1-СДАНО/index.php" class="btn">Открыть</a>
            </div>
        </div>
        ...
        <div class="lab-card">
            ...
            <div class="lab-path">📁 Папка: <code>ЛР2-СДАНО</code></div>
            <div class="btn-group">
                <a href="./ЛР2-СДАНО/index.php" class="btn">Открыть</a>
            </div>
        </div>
        ...
        <div class="lab-card">
            ...
            <div class="lab-path">📁 Папка: <code>ЛР3-СДАНО</code></div>
            <div class="btn-group">
                <a href="./ЛР3-СДАНО/index.php" class="btn">Открыть</a>
            </div>
        </div>
        ...
        <div class="lab-card">
            ...
            <div class="lab-path">📁 Папка: <code>ЛР4-СДАНО</code></div>
            <div class="btn-group">
                <a href="./ЛР4-СДАНО/task1.php" class="btn">task1</a>
                <a href="./ЛР4-СДАНО/task2.php" class="btn">task2</a>
                <a href="./ЛР4-СДАНО/login.php" class="btn">login</a>
                <a href="./ЛР4-СДАНО/admin.php" class="btn">admin</a>
                <a href="./ЛР4-СДАНО/logout.php" class="btn">logout</a>
            </div>
        </div>
        ...
        <div class="lab-card">
            ...
            <div class="lab-path">📁 Папка: <code>ЛР5-СДАНО</code></div>
            <div class="btn-group">
                <a href="./ЛР5-СДАНО/task1.php" class="btn">task1</a>
                <a href="./ЛР5-СДАНО/guestbook.php" class="btn">Гостевая книга</a>
            </div>
        </div>
        ...
        <div class="lab-card">
            ...
            <div class="lab-path">📁 Папка: <code>ЛР6-СДАНО</code></div>
            <div class="btn-group">
                <a href="./ЛР6-СДАНО/task1_mail.php" class="btn">task1 (mail)</a>
                <a href="./ЛР6-СДАНО/task2_phpmailer.php" class="btn">task2 (PHPMailer)</a>
                <a href="./ЛР6-СДАНО/subscribe.php" class="btn">Подписка</a>
            </div>
        </div>
        ...
        <div class="lab-card" style="border-left-color: #ff6b4a;">
            ...
            <div class="lab-desc">Магазин товаров для собак (MVC + MySQL)</div>
